...
${OBJECTDIR}/src/dpi_conntrack_file.o: src/dpi_conntrack_file.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dpi_conntrack_file.o src/dpi_conntrack_file.c

${OBJECTDIR}/src/module.o: src/module.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/module.o src/module.c

${OBJECTDIR}/src/netns.o: src/netns.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/netns.o src/netns.c

${OBJECTDIR}/src/procfs.o: src/procfs.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/procfs.o src/procfs.c
